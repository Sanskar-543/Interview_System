...
|---|---|---|
| Web Application | Vercel | [https://interview-system-web.vercel.app](https://interview-system-web.vercel.app) |
| API Gateway | Render | [https://interview-gateway-latest.onrender.com](https://interview-gateway-latest.onrender.com) |
| Voice Service | Render | `wss://interview-voice-1lks.onrender.com` |
| Evaluation Worker | Render | [https://interview-worker-latest-r8sx.onrender.com](https://interview-worker-latest-r8sx.onrender.com) |
...
| API service | Render | Free web service |
| Voice service | Render | Free web service |
