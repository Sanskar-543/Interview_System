    ...
    <>
      <header style={styles.navHeader}>
        <div style={styles.navContainer}>
          ...
          {/* Navigation Links — Now open Pop-up Info Windows */}
          <nav style={styles.navLinks}>
            <button onClick={() => setActiveInfoModal('features')} style={styles.navBtnLink}>
              Features
            </button>
            <button onClick={() => setActiveInfoModal('about')} style={styles.navBtnLink}>
              About Us
            </button>
            <button onClick={() => setActiveInfoModal('faq')} style={styles.navBtnLink}>
              Help / FAQ
            </button>
            <button onClick={() => setActiveInfoModal('contact')} style={styles.navBtnLink}>
              Contact
            </button>
          </nav>
            ...
            {isLoggedIn ? (
              <>
                ...
                >
                  ...
                  <span style={styles.profileName}>{user?.name || 'Candidate'}</span>
                </button>
      ...
      {/* INTERACTIVE POP-UP INFO WINDOW MODAL */}
      {activeInfoModal && (
        <div style={styles.modalOverlay}>
          <div style={styles.modalWindow}>
            ...
            <div style={styles.modalTopBar}>
              <button
                id="info-modal-back-btn"
                onClick={() => setActiveInfoModal(null)}
                style={styles.modalBackBtn}
              >
                <ArrowLeft size={16} /> Back to {isLoggedIn ? 'Dashboard' : 'Main Window'}
              </button>
