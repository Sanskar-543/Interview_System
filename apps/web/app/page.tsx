...
export default function HomePage() {
  ...
  const [userPlan, setUserPlan] = useState<'free' | 'paid' | 'pro'>('free');
  ...
  const fetchUserDataAndSessions = async (token: string) => {
    try {
          ...
          <section style={styles.heroSection}>
            ...
            <div style={styles.heroCtas}>
              <button
                ...
                onClick={() => router.push(isLoggedIn ? '/interview' : '/login')}
          ...
          <section id="pricing" style={styles.sectionWrapper}>
            ...
            <div style={styles.pricingGrid}>
              ...
              <div style={styles.pricingCard}>
                ...
                <button onClick={() => router.push(isLoggedIn ? '/interview' : '/login')} style={styles.freePlanBtn}>
                  Get Started Free
                </button>
              </div>
              ...
              <div style={{ ...styles.pricingCard, border: '2px solid #3B82F6', position: 'relative' }}>
                ...
                <button onClick={() => router.push(isLoggedIn ? '/billing' : '/login')} style={styles.proPlanBtn}>
                  Upgrade to Pro
                </button>
              </div>
            </div>
