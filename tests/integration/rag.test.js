...
import { getEmbedding } from '../../packages/rag/embed.js';
import { searchKnowledge } from '../../packages/rag/search.js';
import { processEvaluationJob } from '../../apps/worker/jobs/eval.js';
import { CircuitBreaker } from '../../apps/voice-service/circuit/breaker.js';
import { db, sessions, turns, reports, users } from '../../packages/db/index.js';
...
test('CircuitBreaker Fallbacks: Exercises all four levels explicitly', async () => {
  ...
  const mockCompletionsCall = async (model) => {
